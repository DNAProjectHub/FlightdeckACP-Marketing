...
export default function DevModeCallout() {
  ...
  // Auto-cycle every 3.5s unless user is hovering
  useEffect(() => {
    if (paused) return;
  ...
  return (
    <section className="py-20 border-b border-fd-border">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-base text-fd-gray leading-relaxed">
              ...
              governance, same surfaces — just the naming you&apos;d expect from
              a dev tool.
            </p>

            {/* Animated naming toggle */}
            <div
          ...
          <ScreenshotFrame
            ...
            alt="FlightDeck in Developer Mode — sidebar showing dev-native naming: System Overview, Agents & Connections, Diagnostics, Schema Explorer"
