...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col justify-center pt-16 pb-0 overflow-hidden">
      {/* Ambient glow */}
      ...
      <div className="flex-1 flex items-center">
        <div className="mx-auto max-w-6xl px-6 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
          {/* Copy */}
          <motion.div
